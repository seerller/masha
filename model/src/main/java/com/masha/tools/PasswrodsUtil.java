...
public class PasswrodsUtil {
    ...
    public static void main(String args[]){
     ...
     String pwd=   PasswrodsUtil.resultNewPassword("123456");
        System.out.println(pwd);

        System.out.println(PasswrodsUtil.oldOrNewIsEquals("7d945acf33a6a0fe84d809f8b16a4e3bab6c2a7771307f9212851850","11111111"));
    }
    ...
    public static boolean oldOrNewIsEquals(String oldPassword,String password){
        password = resultNewPassword(EncryptUtil.decodeHex(oldPassword.substring(0, 16)),password);
