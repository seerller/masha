...
public class LunarUtil {
     ...
     * 香港阳历公众假期
     */
    private String[] lunars = {"01-01","04-05","04-19","04-22","05-01","07-01","12-25","12-26"};
    /**
     * 香港阴历公众假期
     */
    private String[] lunars_ = {"01-01","01-02","01-03","04-08","05-05","08-15","09-09"};
    ...
    public static void test(long now) throws ParseException{

    }
    public static void main(String[] args) throws ParseException {
        long now = System.currentTimeMillis();
        List<LunarUtil> lunars = new ArrayList<>();
        Date date = new Date(now);
        Calendar today = Calendar.getInstance();
        today.setTime(date);
        lunars.add(new LunarUtil(today));
        System.out.println(lunars.toString());
    }
